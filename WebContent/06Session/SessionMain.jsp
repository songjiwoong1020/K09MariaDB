...
<body>
	...
	<h2>세션 유지시간 session내장객체 사용하기</h2>
		<%
		/*
		web.xml에서 설정 할 때는 분단위로 설정하고, 만약 설정값이 없을때는
		30분(1800초)로 설정된다. 웹 어플리케이션이 실행 될 때는 web.xml이
		먼저 설정되고, 아래 JSP코드가 실행되게 된다.
		*/
		//내장객체를 사용 할 때는 초단위로 설정한다.
	...
	%>
	<ul>
		<li>최초 요청시간 : <%=creationTimeString %></li>
