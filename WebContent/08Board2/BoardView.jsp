...
System.out.println("뷰에서 nowPage=" + nowPage);
//폼값 받기 - 파라미터로 전달된 게시물의 일련번호(쿼리스트링형태?)
	...
	<div class="row">		
		...
		<div class="col-9 pt-3">
			...
			<div class="row mt-3 mr-1">
				...
				<tbody>
					<tr>
						<th class="text-center table-active align-middle">id</th>
						<td><%=dto.getId() %></td>
					...
					<tr>
						...
						<td colspan="3" class="align-middle" style="height:200px;">
							...
							HTML페이지에서 출력 할때는 <br/>태그로 문자열을 변경해야 한다.
							--%>
			...
			<div class="row mb-3">
				...
				*/
				if(session.getAttribute("USER_ID") != null &&
					...
					<!-- 
					회원제 게시판에 삭제처리는 별도의 폼이 필요없이, 사용자에대한 인증만 되면 즉시
					삭제 처리한다.
					 -->
				...
				함수를 이용해서 폼값을 전송한다. 해당 HTML문서 어디든지 위치 할 수 있다.
				 -->
				<form name="deleteFrm">
