...
<div class="container">
	...
	<div class="row">		
		...
		<div class="col-9 pt-3">
			<h3><%=boardTitle %>게시판 - <small>Write(작성)</small></h3>
	<script>
	function checkValidate(frm){
		if(frm.title.value == ""){
			alert("제목을 입력하세요");//경고창 띄움
			frm.title.focus();//입력란으로 포커스 이동
			return false;//전송이 되지 않도록 이벤트리스너로 false반환
		}
	...
	var checkValidate2 = function(frm){
			...
			<div class="row mt-3 mr-1">
				...
				<form action="WriteProc.jsp" name="writeFrm" method="psot"
						onsubmit="return checkValidate(this)">
				<!-- 글 작성시 게시판 구분을 위한 flag 추가 -->
